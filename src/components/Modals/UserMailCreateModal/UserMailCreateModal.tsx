...
import { Input, InputMailUser, Checkbox } from '@/components/Forms';
...
export interface UserMailCreateModalProps {
  isOpen: boolean;
  onClose: () => void;
  userMail: UserMail | null;
}

const UserMailCreateModal: FC<UserMailCreateModalProps> = ({
  isOpen,
  onClose,
  userMail,
}) => {
...
export default UserMailCreateModal;
